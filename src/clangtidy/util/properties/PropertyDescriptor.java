 ...
 */
public class PropertyDescriptor<Type> {
	private String			name;
	...
	static PropertyDescriptor create(@NotNull Field field) {
		Property property = field.getAnnotation(Property.class);
		if (property != null) {
			PropertyDescriptor pdesc = new PropertyDescriptor(field);
	...
	private PropertyDescriptor(@NotNull Field field) {
		@SuppressWarnings("unchecked")
